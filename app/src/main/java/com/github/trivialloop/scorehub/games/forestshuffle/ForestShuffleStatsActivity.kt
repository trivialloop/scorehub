...
import com.github.trivialloop.scorehub.databinding.ActivityForestshuffleStatsBinding
import com.github.trivialloop.scorehub.utils.LocaleHelper
import kotlinx.coroutines.launch

class ForestShuffleStatsActivity : AppCompatActivity() {

    private lateinit var binding: ActivityForestshuffleStatsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityForestshuffleStatsBinding.inflate(layoutInflater)
    ...
    private fun loadStats() {
        lifecycleScope.launch {
            database.playerDao().getAllPlayers().collect { players ->
                val statsList = mutableListOf<ForestShufflePlayerStatsEntry>()
                ...
                statsList.sortWith(
                    compareByDescending<ForestShufflePlayerStatsEntry> { it.winPercentage }
                ...
                binding.recyclerView.adapter = ForestShuffleStatsAdapter(statsList)
            }
        }
    }
...
data class ForestShufflePlayerStatsEntry(
    val player: Player,
    val totalGames: Int,
...
class ForestShuffleStatsAdapter(private val stats: List<ForestShufflePlayerStatsEntry>) :
    RecyclerView.Adapter<ForestShuffleStatsAdapter.ViewHolder>() {
