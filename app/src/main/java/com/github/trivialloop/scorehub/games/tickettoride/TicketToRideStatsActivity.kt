...
import com.github.trivialloop.scorehub.databinding.ActivityTickettorideStatsBinding
import com.github.trivialloop.scorehub.utils.LocaleHelper
import kotlinx.coroutines.launch

class TicketToRideStatsActivity : AppCompatActivity() {

    private lateinit var binding: ActivityTickettorideStatsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityTickettorideStatsBinding.inflate(layoutInflater)
    ...
    private fun loadStats() {
        lifecycleScope.launch {
            database.playerDao().getAllPlayers().collect { players ->
                val statsList = mutableListOf<TicketToRidePlayerStatsEntry>()
                ...
                statsList.sortWith(
                    compareByDescending<TicketToRidePlayerStatsEntry> { it.winPercentage }
                ...
                binding.recyclerView.adapter = TicketToRideStatsAdapter(statsList)
            }
        }
    }
...
data class TicketToRidePlayerStatsEntry(
    val player: Player,
    val totalGames: Int,
...
class TicketToRideStatsAdapter(private val stats: List<TicketToRidePlayerStatsEntry>) :
    RecyclerView.Adapter<TicketToRideStatsAdapter.ViewHolder>() {
