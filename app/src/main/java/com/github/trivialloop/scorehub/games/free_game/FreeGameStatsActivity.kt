...
import com.github.trivialloop.scorehub.databinding.ActivityFreegameStatsBinding
import com.github.trivialloop.scorehub.utils.LocaleHelper
import kotlinx.coroutines.launch

class FreeGameStatsActivity : AppCompatActivity() {

    private lateinit var binding: ActivityFreegameStatsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityFreegameStatsBinding.inflate(layoutInflater)
    ...
    private fun loadStats() {
        lifecycleScope.launch {
            database.playerDao().getAllPlayers().collect { players ->
                val statsList = mutableListOf<FreeGamePlayerStatsEntry>()
                ...
                statsList.sortWith(
                    compareByDescending<FreeGamePlayerStatsEntry> { it.winPercentage }
                ...
                binding.recyclerView.adapter = FreeGameStatsAdapter(statsList)
            }
        }
    }
...
data class FreeGamePlayerStatsEntry(
    val player: Player,
    val totalGames: Int,
...
class FreeGameStatsAdapter(private val stats: List<FreeGamePlayerStatsEntry>) :
    RecyclerView.Adapter<FreeGameStatsAdapter.ViewHolder>() {
