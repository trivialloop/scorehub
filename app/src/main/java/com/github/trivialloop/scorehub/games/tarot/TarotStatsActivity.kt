...
import com.github.trivialloop.scorehub.databinding.ActivityTarotStatsBinding
...
class TarotStatsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityTarotStatsBinding.inflate(layoutInflater)
    ...
    private fun loadStats() {
        lifecycleScope.launch {
            database.playerDao().getAllPlayers().collect { players ->
                val statsList = mutableListOf<TarotPlayerStatsEntry>()
                ...
                statsList.sortWith(
                    compareByDescending<TarotPlayerStatsEntry> { it.winPercentage }
                ...
                binding.recyclerView.adapter = TarotStatsAdapter(statsList)
            }
        }
    }
...
data class TarotPlayerStatsEntry(
    val player: Player,
    val totalGames: Int,
...
class TarotStatsAdapter(private val stats: List<TarotPlayerStatsEntry>) :
    RecyclerView.Adapter<TarotStatsAdapter.ViewHolder>() {
