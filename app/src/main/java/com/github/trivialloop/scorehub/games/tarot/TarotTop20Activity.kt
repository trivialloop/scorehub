...
import com.github.trivialloop.scorehub.databinding.ActivityTarotTop20Binding
import com.github.trivialloop.scorehub.utils.LocaleHelper
import kotlinx.coroutines.launch
import java.text.SimpleDateFormat
import java.util.*

class TarotTop20Activity : AppCompatActivity() {

    private lateinit var binding: ActivityTarotTop20Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityTarotTop20Binding.inflate(layoutInflater)
    ...
    private fun loadTop20() {
        lifecycleScope.launch {
            ...
            val entries = results.map { result ->
                ...
                TarotTop20Entry(result, player?.color ?: android.graphics.Color.GRAY)
            }
            binding.recyclerView.adapter = TarotTop20Adapter(entries)
        }
    }
...
data class TarotTop20Entry(val result: GameResult, val color: Int)

class TarotTop20Adapter(private val entries: List<TarotTop20Entry>) :
    RecyclerView.Adapter<TarotTop20Adapter.ViewHolder>() {
