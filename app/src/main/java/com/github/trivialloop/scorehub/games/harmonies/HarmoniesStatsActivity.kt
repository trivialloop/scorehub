...
import com.github.trivialloop.scorehub.databinding.ActivityHarmoniesStatsBinding
import com.github.trivialloop.scorehub.utils.LocaleHelper
import kotlinx.coroutines.launch

class HarmoniesStatsActivity : AppCompatActivity() {

    private lateinit var binding: ActivityHarmoniesStatsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityHarmoniesStatsBinding.inflate(layoutInflater)
    ...
    private fun loadStats() {
        lifecycleScope.launch {
            database.playerDao().getAllPlayers().collect { players ->
                val statsList = mutableListOf<HarmoniesPlayerStatsEntry>()
                ...
                statsList.sortWith(
                    compareByDescending<HarmoniesPlayerStatsEntry> { it.winPercentage }
                ...
                binding.recyclerView.adapter = HarmoniesStatsAdapter(statsList)
            }
        }
    }
...
data class HarmoniesPlayerStatsEntry(
    val player: Player,
    val totalGames: Int,
...
class HarmoniesStatsAdapter(private val stats: List<HarmoniesPlayerStatsEntry>) :
    RecyclerView.Adapter<HarmoniesStatsAdapter.ViewHolder>() {
