...
import com.github.trivialloop.scorehub.databinding.ActivityOhHellStatsBinding
import com.github.trivialloop.scorehub.utils.LocaleHelper
import kotlinx.coroutines.launch

class OhHellStatsActivity : AppCompatActivity() {

    private lateinit var binding: ActivityOhHellStatsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityOhHellStatsBinding.inflate(layoutInflater)
    ...
    private fun loadStats() {
        lifecycleScope.launch {
            database.playerDao().getAllPlayers().collect { players ->
                val statsList = mutableListOf<OhHellPlayerStatsEntry>()
                ...
                statsList.sortWith(
                    compareByDescending<OhHellPlayerStatsEntry> { it.winPercentage }
                ...
                binding.recyclerView.adapter = OhHellStatsAdapter(statsList)
            }
        }
    }
...
data class OhHellPlayerStatsEntry(
    val player: Player,
    val totalGames: Int,
...
class OhHellStatsAdapter(private val stats: List<OhHellPlayerStatsEntry>) :
    RecyclerView.Adapter<OhHellStatsAdapter.ViewHolder>() {
