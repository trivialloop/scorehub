...
import com.github.trivialloop.scorehub.databinding.ActivityFlip7StatsBinding
import com.github.trivialloop.scorehub.utils.LocaleHelper
import kotlinx.coroutines.launch

class Flip7StatsActivity : AppCompatActivity() {

    private lateinit var binding: ActivityFlip7StatsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityFlip7StatsBinding.inflate(layoutInflater)
    ...
    private fun loadStats() {
        lifecycleScope.launch {
            database.playerDao().getAllPlayers().collect { players ->
                val statsList = mutableListOf<Flip7PlayerStatsEntry>()
                ...
                statsList.sortWith(
                    compareByDescending<Flip7PlayerStatsEntry> { it.winPercentage }
                ...
                binding.recyclerView.adapter = Flip7StatsAdapter(statsList)
            }
        }
    }
...
data class Flip7PlayerStatsEntry(
    val player: Player,
    val totalGames: Int,
...
class Flip7StatsAdapter(private val stats: List<Flip7PlayerStatsEntry>) :
    RecyclerView.Adapter<Flip7StatsAdapter.ViewHolder>() {
