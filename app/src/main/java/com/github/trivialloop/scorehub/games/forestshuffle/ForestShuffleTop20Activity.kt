...
import com.github.trivialloop.scorehub.databinding.ActivityForestshuffleTop20Binding
import com.github.trivialloop.scorehub.utils.LocaleHelper
import kotlinx.coroutines.launch
import java.text.SimpleDateFormat
import java.util.*

class ForestShuffleTop20Activity : AppCompatActivity() {

    private lateinit var binding: ActivityForestshuffleTop20Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityForestshuffleTop20Binding.inflate(layoutInflater)
    ...
    private fun loadTop20() {
        lifecycleScope.launch {
            ...
            val entries = results.map { result ->
                ...
                ForestShuffleTop20Entry(result, player?.color ?: android.graphics.Color.GRAY)
            }
            binding.recyclerView.adapter = ForestShuffleTop20Adapter(entries)
        }
    }
...
data class ForestShuffleTop20Entry(val result: GameResult, val color: Int)

class ForestShuffleTop20Adapter(private val entries: List<ForestShuffleTop20Entry>) :
    RecyclerView.Adapter<ForestShuffleTop20Adapter.ViewHolder>() {
