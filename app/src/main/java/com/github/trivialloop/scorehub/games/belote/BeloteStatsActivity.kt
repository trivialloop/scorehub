...
import com.github.trivialloop.scorehub.databinding.ActivityBeloteStatsBinding
import com.github.trivialloop.scorehub.utils.LocaleHelper
import kotlinx.coroutines.launch

class BeloteStatsActivity : AppCompatActivity() {

    private lateinit var binding: ActivityBeloteStatsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityBeloteStatsBinding.inflate(layoutInflater)
    ...
    private fun loadStats() {
        lifecycleScope.launch {
            database.playerDao().getAllPlayers().collect { players ->
                val statsList = mutableListOf<BelotePlayerStatsEntry>()
                ...
                statsList.sortWith(
                    compareByDescending<BelotePlayerStatsEntry> { it.winPercentage }
                ...
                binding.recyclerView.adapter = BeloteStatsAdapter(statsList)
            }
        }
    }
...
data class BelotePlayerStatsEntry(
    val player: Player,
    val totalGames: Int,
...
class BeloteStatsAdapter(private val stats: List<BelotePlayerStatsEntry>) :
    RecyclerView.Adapter<BeloteStatsAdapter.ViewHolder>() {
