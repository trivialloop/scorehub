...
import com.github.trivialloop.scorehub.databinding.ActivityCactusStatsBinding
import com.github.trivialloop.scorehub.utils.LocaleHelper
import kotlinx.coroutines.launch

class CactusStatsActivity : AppCompatActivity() {

    private lateinit var binding: ActivityCactusStatsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCactusStatsBinding.inflate(layoutInflater)
    ...
    private fun loadStats() {
        lifecycleScope.launch {
            database.playerDao().getAllPlayers().collect { players ->
                val statsList = mutableListOf<CactusPlayerStatsEntry>()
                ...
                statsList.sortWith(
                    compareByDescending<CactusPlayerStatsEntry> { it.winPercentage }
                ...
                binding.recyclerView.adapter = CactusStatsAdapter(statsList)
            }
        }
    }
...
data class CactusPlayerStatsEntry(
    val player: Player,
    val totalGames: Int,
...
class CactusStatsAdapter(private val stats: List<CactusPlayerStatsEntry>) :
    RecyclerView.Adapter<CactusStatsAdapter.ViewHolder>() {
