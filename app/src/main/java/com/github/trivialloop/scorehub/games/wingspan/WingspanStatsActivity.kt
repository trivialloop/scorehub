...
import com.github.trivialloop.scorehub.databinding.ActivityWingspanStatsBinding
import com.github.trivialloop.scorehub.utils.LocaleHelper
import kotlinx.coroutines.launch

class WingspanStatsActivity : AppCompatActivity() {

    private lateinit var binding: ActivityWingspanStatsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityWingspanStatsBinding.inflate(layoutInflater)
    ...
    private fun loadStats() {
        lifecycleScope.launch {
            database.playerDao().getAllPlayers().collect { players ->
                val statsList = mutableListOf<WingspanPlayerStatsEntry>()
                ...
                statsList.sortWith(
                    compareByDescending<WingspanPlayerStatsEntry> { it.winPercentage }
                ...
                binding.recyclerView.adapter = WingspanStatsAdapter(statsList)
            }
        }
    }
...
data class WingspanPlayerStatsEntry(
    val player: Player,
    val totalGames: Int,
...
class WingspanStatsAdapter(private val stats: List<WingspanPlayerStatsEntry>) :
    RecyclerView.Adapter<WingspanStatsAdapter.ViewHolder>() {
