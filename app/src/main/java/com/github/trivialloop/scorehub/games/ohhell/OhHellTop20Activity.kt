...
import com.github.trivialloop.scorehub.databinding.ActivityOhHellTop20Binding
import com.github.trivialloop.scorehub.utils.LocaleHelper
import kotlinx.coroutines.launch
import java.text.SimpleDateFormat
import java.util.*

class OhHellTop20Activity : AppCompatActivity() {

    private lateinit var binding: ActivityOhHellTop20Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityOhHellTop20Binding.inflate(layoutInflater)
    ...
    private fun loadTop20() {
        lifecycleScope.launch {
            ...
            val entries = results.map { result ->
                ...
                OhHellTop20Entry(result, player?.color ?: android.graphics.Color.GRAY)
            }
            binding.recyclerView.adapter = OhHellTop20Adapter(entries)
        }
    }
...
data class OhHellTop20Entry(val result: GameResult, val color: Int)

class OhHellTop20Adapter(private val entries: List<OhHellTop20Entry>) :
    RecyclerView.Adapter<OhHellTop20Adapter.ViewHolder>() {
