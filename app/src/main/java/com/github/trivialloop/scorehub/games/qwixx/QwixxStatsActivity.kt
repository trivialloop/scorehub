...
import com.github.trivialloop.scorehub.databinding.ActivityQwixxStatsBinding
import com.github.trivialloop.scorehub.utils.LocaleHelper
import kotlinx.coroutines.launch

class QwixxStatsActivity : AppCompatActivity() {

    private lateinit var binding: ActivityQwixxStatsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityQwixxStatsBinding.inflate(layoutInflater)
    ...
    private fun loadStats() {
        lifecycleScope.launch {
            database.playerDao().getAllPlayers().collect { players ->
                val statsList = mutableListOf<QwixxPlayerStatsEntry>()
                ...
                for (player in players) {
                    ...
                    if (totalGames > 0) {
                        ...
                        statsList.add(QwixxPlayerStatsEntry(
                ...
                statsList.sortWith(
                    compareByDescending<QwixxPlayerStatsEntry> { it.winPercentage }
                ...
                binding.recyclerView.adapter = QwixxStatsAdapter(statsList)
            }
        }
    }
...
data class QwixxPlayerStatsEntry(
    val player: Player,
    val totalGames: Int,
...
class QwixxStatsAdapter(private val stats: List<QwixxPlayerStatsEntry>) :
    RecyclerView.Adapter<QwixxStatsAdapter.ViewHolder>() {
