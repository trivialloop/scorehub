...
import com.github.trivialloop.scorehub.databinding.ActivityAkropolisStatsBinding
import com.github.trivialloop.scorehub.utils.LocaleHelper
import kotlinx.coroutines.launch

class AkropolisStatsActivity : AppCompatActivity() {

    private lateinit var binding: ActivityAkropolisStatsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAkropolisStatsBinding.inflate(layoutInflater)
    ...
    private fun loadStats() {
        lifecycleScope.launch {
            database.playerDao().getAllPlayers().collect { players ->
                val statsList = mutableListOf<AkropolisPlayerStatsEntry>()
                ...
                statsList.sortWith(
                    compareByDescending<AkropolisPlayerStatsEntry> { it.winPercentage }
                ...
                binding.recyclerView.adapter = AkropolisStatsAdapter(statsList)
            }
        }
    }
...
data class AkropolisPlayerStatsEntry(
    val player: Player,
    val totalGames: Int,
...
class AkropolisStatsAdapter(private val stats: List<AkropolisPlayerStatsEntry>) :
    RecyclerView.Adapter<AkropolisStatsAdapter.ViewHolder>() {
