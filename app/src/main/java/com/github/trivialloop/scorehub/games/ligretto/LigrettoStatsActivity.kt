...
import com.github.trivialloop.scorehub.databinding.ActivityLigrettoStatsBinding
import com.github.trivialloop.scorehub.utils.LocaleHelper
import kotlinx.coroutines.launch

class LigrettoStatsActivity : AppCompatActivity() {

    private lateinit var binding: ActivityLigrettoStatsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityLigrettoStatsBinding.inflate(layoutInflater)
    ...
    private fun loadStats() {
        lifecycleScope.launch {
            database.playerDao().getAllPlayers().collect { players ->
                val statsList = mutableListOf<LigrettoPlayerStatsEntry>()
                ...
                statsList.sortWith(
                    compareByDescending<LigrettoPlayerStatsEntry> { it.winPercentage }
                ...
                binding.recyclerView.adapter = LigrettoStatsAdapter(statsList)
            }
        }
    }
...
data class LigrettoPlayerStatsEntry(
    val player: Player,
    val totalGames: Int,
...
class LigrettoStatsAdapter(private val stats: List<LigrettoPlayerStatsEntry>) :
    RecyclerView.Adapter<LigrettoStatsAdapter.ViewHolder>() {
