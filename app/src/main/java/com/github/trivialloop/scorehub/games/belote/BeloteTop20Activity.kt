...
import com.github.trivialloop.scorehub.databinding.ActivityBeloteTop20Binding
import com.github.trivialloop.scorehub.utils.LocaleHelper
import kotlinx.coroutines.launch
import java.text.SimpleDateFormat
import java.util.*

class BeloteTop20Activity : AppCompatActivity() {

    private lateinit var binding: ActivityBeloteTop20Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityBeloteTop20Binding.inflate(layoutInflater)
    ...
    private fun loadTop20() {
        lifecycleScope.launch {
            ...
            val entries = results.map { result ->
                ...
                BeloteTop20Entry(result, player?.color ?: android.graphics.Color.GRAY)
            }
            binding.recyclerView.adapter = BeloteTop20Adapter(entries)
        }
    }
...
data class BeloteTop20Entry(val result: GameResult, val color: Int)

class BeloteTop20Adapter(private val entries: List<BeloteTop20Entry>) :
    RecyclerView.Adapter<BeloteTop20Adapter.ViewHolder>() {
